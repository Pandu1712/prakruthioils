      ...
      <div className="container mx-auto px-6">
        <div className="relative bg-[#3d0a0a] rounded-[50px] p-12 md:p-24 overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            <h2 className="text-[36px] font-medium text-white tracking-tight mb-8">Ready to Order?</h2>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-8">
              <button 
                ...
                className="px-8 py-4 bg-[#9EA233] text-white rounded-md font-medium text-base uppercase tracking-widest flex items-center gap-3 hover:bg-[#7D8128] transition-all transform hover:scale-105 shadow-xl"
              >
              ...
              <a href="tel:8073516982" className="flex items-center gap-2 text-[24px] font-medium text-white hover:text-[#9EA233] transition-colors leading-none">
                <PhoneCall className="w-6 h-6 text-[#9EA233]" /> 
